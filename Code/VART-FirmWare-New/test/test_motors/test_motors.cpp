...
const auto left_driver = hardware::MotorDriverL293(vart::Pins::left_driver_a, vart::Pins::left_driver_b);

const auto right_driver = hardware::MotorDriverL293(vart::Pins::right_driver_a, vart::Pins::right_driver_b);
...
void move(const hardware::MotorDriverL293 &driver, int power) {
...
void setup() {
    ...
    move(hardware::MotorDriverL293(vart::left_driver_a, vart::left_driver_b), 255);
    move(hardware::MotorDriverL293(vart::left_driver_a, vart::left_driver_b), -255);
