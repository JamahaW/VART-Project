...
hardware::MotorRegulator hardware::MotorRegulator::makeLeft(const MotorRegulatorConfig &config) {
    return MotorRegulator(
        config,
        hardware::Encoder::makeLeft(),
        hardware::MotorDriverL293::makeLeft()
    );
}

hardware::MotorRegulator hardware::MotorRegulator::makeRight(const MotorRegulatorConfig &config) {
    return MotorRegulator(
        config,
        hardware::Encoder::makeRight(),
        hardware::MotorDriverL293::makeRight()
    );
}
